...
- **Clarity**: Use descriptive test and step titles that clearly state the intent. Add comments only to explain complex logic, non-obvious interactions, or the reason for a testing workaround. Do not restate the test step or assertion.
- Keep test comments current when locators, behavior, or accessibility expectations change.
